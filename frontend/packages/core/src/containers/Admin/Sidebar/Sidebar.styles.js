...
import DashboardIcon from '@iso/assets/images/icon/dashboard-white-icon.svg';
import BillingIcon from '@iso/assets/images/icon/billing-icon.svg';
import BrandappIcon from '@iso/assets/images/icon/branded-app-icon.svg';
import AppDefaultIcon from '@iso/assets/images/icon/app-defaults-icon.svg';
import DiscountsIcon from '@iso/assets/images/icon/discounts-icon.svg';
import SubscriptionPlanIcon from '@iso/assets/images/icon/subscription-plans-icon.svg';
import SupportIcon from '@iso/assets/images/icon/support-white-icon.svg';
import UserIcon from '@iso/assets/images/icon/users-icon.svg';
import MessageIcon from '@iso/assets/images/icon/messages-icon.svg';
